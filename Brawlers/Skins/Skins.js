...
const SKINS = [
    // Skins de Shelly
    { name: "Shelly Padrão", brawler: "Shelly", emoji: "🩸", rarity: "mythic", theme: "madevil", price: "249 Gems", badge: "", desc: "Shelly com visual de bandida do rock gótico. Tema MadEvil." },
    ...
    { name: "Shelly Cibernética", brawler: "Shelly", emoji: "🥇", rarity: "legendary", theme: "Rebelião Ramen", price: "299 Gems", badge: "new", desc: "Versão metálica ouro de Shelly. Requer True Silver primeiro." },
    // Skins de Colt
    ...
    { name: "Rosa Retrofuturista", brawler: "Rosa", emoji: "🥇", rarity: "brawlpass", theme: "Ventópole", price: "Brawl Pass (T53)", badge: "brawlpass", desc: "Versão metálica ouro de Rosa. Requer True Silver primeiro." },
    ...
    { name: "Bea Patrulha Starr", brawler: "Bea", emoji: "🤖", rarity: "epic", theme: "patrulhastarr", price: "149 Gems", badge: "new", desc: "Uma versão vigilante e tecnológica da Bea em Brawl Stars, com traje de patrulha futurista e visual ágil que combina precisão e estilo." },
    { name: "Colette Rainha do Vácuo", brawler: "Colette", emoji: "🥇", rarity: "brawlpass", theme: "patrulhastarr", price: "Brawl Pass (T50)", badge: "brawlpass", desc: "Uma versão sombria e poderosa, com energia do vazio e visual místico que transmite caos e domínio." },
    { name: "Colette Estrela Branca", brawler: "Colette", emoji: "🥇", rarity: "brawlpass", theme: "patrulhastarr", price: "Brawl Pass (T50)", badge: "brawlpass", desc: "Uma versão luminosa e elegante da Colette em Brawl Stars, com visual claro e brilho celestial que transmite pureza e poder." },
    { name: "Colette Buraco Negro", brawler: "Colette", emoji: "🥇", rarity: "brawlpass", theme: "patrulhastarr", price: "Brawl Pass (T50)", badge: "brawlpass", desc: "Uma versão intensa e enigmática da Colette em Brawl Stars, com energia cósmica sombria e efeitos que lembram a força devastadora de um vazio infinito." },
    ...
    { name: "Amber Rainha do Vácuo", brawler: "Amber", emoji: "🌸", rarity: "legendary", theme: "patrulhastarr", price: "299 Gems", badge: "new", desc: "Amber, Rainha do Vácuo, é uma entidade sombria que domina o nada absoluto, envolta por chamas negras e uma aura cósmica que consome luz, som e existência." },
    { name: "Amber Patrulha Starr", brawler: "Amber", emoji: "🌟", rarity: "legendary", theme: "patrulhastarr", price: "299 Gems", badge: "new", desc: "Amber, Patrulha Starr, é uma entidade radiante que personifica a luz pura e a esperança, envolta por chamas brilhantes e uma aura celestial que irradia energia positiva e proteção." },
    ...
    { name: "Tecnotara", brawler: "Tara", emoji: "🥷", rarity: "mythic", theme: "Rebelião Ramen", price: "199 Gems", badge: "new", desc: "Tara como uma ninja urbana." },
    // Skins do Eugénio
    ...
    { name: "Juju Patrulha Starr", brawler: "Juju", emoji: "🌺", rarity: "mythic", theme: "patrulhastarr", price: "199 Gems", badge: "new", desc: "Uma versão heroica e cheia de atitude da Juju em Brawl Stars, com visual de patrulheira futurista e energia pronta para proteger Starr Park com estilo." },
    ...
    { name: "Spike Patrulha Starr", brawler: "Spike", emoji: "🌵", rarity: "brawlpass", theme: "patrulhastarr", price: "Brawl Pass (T50)", badge: "brawlpass", desc: "Skin Spike Patrulha Starr de Brawl Stars transforma o personagem em um aventureiro estiloso com visual vibrante e temático." },
    { name: "Spike Caçador Starr", brawler: "Spike", emoji: "🌵", rarity: "brawlpass", theme: "patrulhastarr", price: "Brawl Pass (T50)", badge: "brawlpass", desc: "Skin Spike Caçador Starr de Brawl Stars transforma o personagem em um aventureiro estiloso com visual vibrante e temático." },
    { name: "Spike Guardião Starr", brawler: "Spike", emoji: "🌵", rarity: "brawlpass", theme: "patrulhastarr", price: "Brawl Pass (T50)", badge: "brawlpass", desc: "Skin Spike Guardião Starr de Brawl Stars transforma o personagem em um aventureiro estiloso com visual vibrante e temático." },
    ...
    { name: "Finx Rei do Vácuo", brawler: "Finx", emoji: "🍄", rarity: "mythic", theme: "patrulhastarr", price: "199 Gems", badge: "new", desc: "Finx, Rei do Vácuo, é um soberano sombrio que governa o nada absoluto, envolto por uma presença cósmica que devora luz, som e toda a existência ao seu redor." },
    { name: "Default Damian", brawler: "Damian", emoji: "🎤", rarity: "legendary", theme: "madevil", price: "Base", badge: "new", desc: "O visual padrão de Damian — vocalista do MadEvil Manor. Recém lançado a 24 de Abril de 2026." },
    { name: "Eugénio Bom de Bola", brawler: "Eugénio", emoji: "⚽", rarity: "brawlpass", theme: "craquesdobrawl", price: "Brawl Pass (T51)", badge: "brawlpass", desc: "Eugénio Bom de Bola é uma versão divertida e desportiva do personagem, com estilo energético e descontraído, mostrando habilidade, precisão e paixão pelo jogo." },
    ...
    // Skins do Mico
    { name: "Mico Sensei", brawler: "Mico", emoji: "🥷", rarity: "brawlpass", theme: "Rebelião Ramen", price: "Brawl Pass (T52)", badge: "brawlpass", desc: "Mico com visual de ninja ágil e furtivo." },
    { name: "Mico Sensei da Terra", brawler: "Mico", emoji: "🥷", rarity: "brawlpass", theme: "Rebelião Ramen", price: "Brawl Pass (T52)", badge: "brawlpass", desc: "Mico com visual de ninja ágil e furtivo." },
    { name: "Mico Sensei das Chamas", brawler: "Mico", emoji: "🥷", rarity: "brawlpass", theme: "Rebelião Ramen", price: "Brawl Pass (T52)", badge: "brawlpass", desc: "Mico com visual de ninja ágil e furtivo." },
    // Skins do Tick
    { name: "Tickoyaki", brawler: "Tick", emoji: "🥇", rarity: "mythic", theme: "Rebelião Ramen", price: "199 Gems", badge: "new", desc: "Versão dourada de Tick." },
    // Skins do Berry
    { name: "Berry Marcial", brawler: "Berry", emoji: "🍓", rarity: "mythic", theme: "Rebelião Ramen", price: "199 Gems", badge: "new", desc: "Berry com visual de fruta fresca e saborosa." },
    // Skins do Jae-Yong
    { name: "Jae-Yong Cyberpunk", brawler: "Jae-Yong", emoji: "🥷", rarity: "brawlpass", theme: "Rebelião Ramen", price: "Brawl Pass (T52)", badge: "brawlpass", desc: "Jae-Yong com visual de samurai ágil e furtivo." },
    { name: "Jae-Yong Choom", brawler: "Jae-Yong", emoji: "🥷", rarity: "brawlpass", theme: "Rebelião Ramen", price: "Brawl Pass (T52)", badge: "brawlpass", desc: "Jae-Yong com visual de samurai ágil e furtivo." },
    { name: "Jae-Yong Nano", brawler: "Jae-Yong", emoji: "🥷", rarity: "brawlpass", theme: "Rebelião Ramen", price: "Brawl Pass (T52)", badge: "brawlpass", desc: "Jae-Yong com visual de samurai ágil e furtivo." },
    // Skins do Byron
    { name: "Byron Biotecnológico", brawler: "Byron", emoji: "🥷", rarity: "brawlpass", theme: "Ventópole", price: "Brawl Pass (T53)", badge: "brawlpass", desc: "Byron com visual de samurai ágil e furtivo." },
    { name: "Byron Biotecnológico", brawler: "Byron", emoji: "🥷", rarity: "brawlpass", theme: "Ventópole", price: "Brawl Pass (T53)", badge: "brawlpass", desc: "Byron com visual de samurai ágil e furtivo." },
    { name: "Byron Sensei das Folhas", brawler: "Byron", emoji: "🥷", rarity: "brawlpass", theme: "Ventópole", price: "Brawl Pass (T53)", badge: "brawlpass", desc: "Byron com visual de samurai ágil e furtivo." },
    // Skins do Kenji
    { name: "Kenji Veterano", brawler: "Kenji", emoji: "🥷", rarity: "mythic", theme: "Ventópole", price: "199 Gems", badge: "new", desc: "Kenji com visual de samurai ágil e furtivo." },
    // Skins do Sprout
    { name: "Sprout Energizado", brawler: "Sprout", emoji: "🥷", rarity: "mythic", theme: "Ventópole", price: "199 Gems", badge: "new", desc: "Sprout com visual de samurai ágil e furtivo." },
    // Skins do Gray
    { name: "Gray Vendaval", brawler: "Gray", emoji: "🥷", rarity: "legendary", theme: "Ventópole", price: "299 Gems", badge: "new", desc: "Gray com visual de samurai ágil e furtivo." },
    // Skins do Moe
    { name: "Moe Turbinado", brawler: "Moe", emoji: "🥷", rarity: "mythic", theme: "Ventópole", price: "199 Gems", badge: "new", desc: "Moe com visual de samurai ágil e furtivo." },
];
...
function render() {
    ...
    grid.innerHTML = filtered.map(sk => {
        ...
        const imgSrc = sk.img || `../Imagens/Skins (imagens)/${sk.brawler}/${sk.name}.png`;
        return `
