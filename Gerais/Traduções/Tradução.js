const TRANSLATIONS = {
    pt: {
        ...
        video4_titulo: "Veja o Nori em ação!",
        ...
        modal_label_dano: "Dano",
        modal_label_estado: "Estado",
        modal_label_novo: "🆕 Novo!",
    ...
    en: {
        ...
        modal_label_classe: "Class",
        modal_label_hp: "HP (PL11)",
        modal_label_dano: "Damage",
        modal_label_estado: "Status",
        modal_label_novo: "🆕 New!",
        modal_btn_stats: "See all stats →",
        modal_btn_skins: "🎨 See all skins →",
